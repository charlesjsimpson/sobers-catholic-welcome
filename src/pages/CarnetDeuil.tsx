    ...
    <>
      ...
      <section className="relative overflow-hidden bg-[hsl(var(--scf-blue))]" style={{ minHeight: 340 }}>
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-6" style={{ minHeight: 340, paddingTop: 96, paddingBottom: 48 }}>
          ...
          >
            Ce carnet rassemble les hommages aux défunts accompagnés par nos agences à travers la France.<br />Chaque nom inscrit dans ce carnet est une vie qui mérite d'être honorée.<br />Recherchez un proche disparu et unissez-vous dans la prière pour les familles.
          </p>
        </div>
      </section>
