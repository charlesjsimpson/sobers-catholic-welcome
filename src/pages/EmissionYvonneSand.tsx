...
const EmissionYvonneSand = () => {
  useEffect(() => {
    document.title = "Dialogue sur la mort : Yvonne Sand, responsable de chambre mortuaire | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Dialogue sur la mort sur Radio Notre Dame et RCF : Yvonne Sand, responsable de chambre mortuaire, partage son expérience de l'accompagnement des défunts et des familles.");
    ...
    <div className="min-h-screen">
      ...
      <main className="pt-20">
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <div className="flex items-center gap-3 text-primary-foreground/70 text-sm mb-4">
              ...
              <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" />28 mars 2025</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Dialogue sur la mort</em> : Yvonne Sand, responsable de chambre mortuaire
            </h1>
          </div>
        </section>
        ...
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer src={radioImg} alt="Dialogue sur la mort – Radio Notre Dame" audioUrl="https://s-c-f.org/wp-content/uploads/2025/03/conversationmort_20250328.mp3" />
            ...
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>Dans cet épisode, <strong>Yvonne Sand</strong>, responsable de chambre mortuaire, partage son expérience quotidienne auprès des défunts et des familles en deuil.</p>
              <p>Elle aborde notamment :</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>Le quotidien en chambre mortuaire</li>
                <li>Le respect et la dignité envers les défunts</li>
                <li>L'accompagnement des familles dans les premiers moments du deuil</li>
                <li>La vocation et le sens de ce métier peu connu</li>
              </ul>
...
export default EmissionYvonneSand;
