...
const EmissionMarionWaller = () => {
  useEffect(() => {
    document.title = "Dialogue sur la mort : Marion Waller, directrice du Pavillon de l'Arsenal | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Dialogue sur la mort sur Radio Notre Dame et RCF : Christian de Cacqueray reçoit Marion Waller, directrice du Pavillon de l'Arsenal, autrice de Redonner une place aux morts.");
    ...
    <div className="min-h-screen">
      ...
      <main className="pt-20">
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <div className="flex items-center gap-3 text-primary-foreground/70 text-sm mb-4">
              ...
              <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" />21 février 2025</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Dialogue sur la mort</em> : Marion Waller
            </h1>
          </div>
        </section>
        ...
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer src={radioImg} alt="Dialogue sur la mort – Radio Notre Dame" audioUrl="https://s-c-f.org/wp-content/uploads/2025/02/conversationmort_20250221.mp3" />
            ...
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>Dans cet épisode, <strong>Marion Waller</strong>, directrice du Pavillon de l'Arsenal, autrice de <em>Redonner une place aux morts</em>, partage sa réflexion sur la place des morts dans la ville.</p>
              <p>Elle aborde notamment :</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>La place des cimetières et des lieux de mémoire dans l'urbanisme</li>
                <li>Comment redonner une place aux morts dans nos villes</li>
                <li>L'architecture funéraire et son évolution</li>
                <li>Le lien entre espace public et mémoire des défunts</li>
              </ul>
...
export default EmissionMarionWaller;
