...
const EmissionPascalDupont = () => {
  useEffect(() => {
    document.title = "Dialogue sur la mort : Pascal Dupont, aumônier de prison | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Dialogue sur la mort sur Radio Notre Dame et RCF : Christian de Cacqueray reçoit Pascal Dupont, aumônier de prison à Dijon.");
        ...
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <div className="flex items-center gap-3 text-primary-foreground/70 text-sm mb-4">
              ...
              <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" />24 janvier 2025</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Dialogue sur la mort</em> : Pascal Dupont, aumônier de prison
            </h1>
          </div>
        </section>
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer src={radioImg} alt="Dialogue sur la mort – Radio Notre Dame" audioUrl="https://s-c-f.org/wp-content/uploads/2025/01/conversationmort_20250124.mp3" />
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>Dans cet épisode, <strong>Pascal Dupont</strong>, aumônier de prison à Dijon et aumônier de la maison d'arrêt, partage son expérience de l'accompagnement spirituel en milieu carcéral.</p>
              <p>Il aborde notamment :</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>La mort et le deuil vécus en prison</li>
                <li>L'accompagnement spirituel des détenus</li>
                <li>La question de la dignité en milieu carcéral</li>
                <li>Le rôle de l'aumônier face à la souffrance</li>
              </ul>
...
export default EmissionPascalDupont;
