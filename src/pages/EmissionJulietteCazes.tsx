...
const EmissionJulietteCazes = () => {
  useEffect(() => {
    document.title = "Dialogue sur la mort : Juliette Cazes, chercheuse en thanatologie | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Dialogue sur la mort sur Radio Notre Dame et RCF : Christian de Cacqueray reçoit Juliette Cazes, chercheuse en thanatologie, autrice de Pionnières du monde funéraire.");
    ...
    <div className="min-h-screen">
      ...
      <main className="pt-20">
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <div className="flex items-center gap-3 text-primary-foreground/70 text-sm mb-4">
              ...
              <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" />14 février 2025</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Dialogue sur la mort</em> : Juliette Cazes
            </h1>
          </div>
        </section>
        ...
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer src={radioImg} alt="Dialogue sur la mort – Radio Notre Dame" audioUrl="https://s-c-f.org/wp-content/uploads/2025/02/conversationmort_20250214.mp3" />
            ...
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>Dans cet épisode, <strong>Juliette Cazes</strong>, chercheuse en thanatologie, autrice de <em>Pionnières du monde funéraire</em>, partage ses recherches sur l'histoire des femmes dans le secteur funéraire.</p>
              <p>Elle aborde notamment :</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>La thanatologie et l'étude de la mort</li>
                <li>Les femmes pionnières du monde funéraire</li>
                <li>L'évolution des pratiques funéraires à travers l'histoire</li>
                <li>Le regard de la société sur les métiers de la mort</li>
              </ul>
            ...
            <div className="mt-16 pt-12 border-t border-border">
              ...
              <div className="grid sm:grid-cols-2 gap-6 mt-8">
                ...
                <Link to="/ressources/emissions/dialogue-sur-la-mort-avec-gregoire-lecalot-journaliste" className="group card-subtle flex gap-4 items-start">
                  <Radio className="w-8 h-8 text-primary shrink-0 mt-1" />
                  <div>
                    <p className="text-xs text-muted-foreground mb-1">21 mars 2025</p>
                    <h3 className="font-semibold text-foreground group-hover:text-primary transition-colors text-sm leading-snug">Dialogue sur la mort, avec Grégoire Lecalot, journaliste</h3>
                  </div>
                </Link>
              </div>
            </div>
...
export default EmissionJulietteCazes;
