...
const EmissionCatherineBossaert = () => {
  useEffect(() => {
    document.title = "Dialogue sur la mort : Catherine Bossaert, coach certifiée, accompagnante au deuil | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Dialogue sur la mort sur Radio Notre Dame et RCF : Catherine Bossaert, coach certifiée et accompagnante au deuil, partage son expérience d'accompagnement des personnes endeuillées.");
      ...
      <main className="pt-20">
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Dialogue sur la mort</em> : Catherine Bossaert, coach certifiée, accompagnante au deuil
            </h1>
          </div>
        </section>
        ...
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer
              src={catherineImg}
              alt="Catherine Bossaert, coach certifiée, accompagnante au deuil"
              audioUrl="https://s-c-f.org/wp-content/uploads/2025/05/conversationmort_20250516.mp3"
            />
            ...
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>
                Dans cet épisode, <strong>Catherine Bossaert</strong>, cheffe d'accompagnement des blessés de la police nationale, coach certifiée et accompagnante au deuil, partage son expérience auprès des personnes endeuillées.
              </p>

              <p>Elle aborde notamment :</p>

              <ul className="list-disc pl-6 space-y-2">
                <li>L'accompagnement professionnel du deuil</li>
                <li>Le coaching face à l'épreuve de la perte</li>
                <li>La place de l'écoute et de la bienveillance</li>
                <li>Son parcours auprès des blessés de la police nationale</li>
              </ul>
            ...
            <div className="mt-16 pt-12 border-t border-border">
              ...
              <div className="grid sm:grid-cols-2 gap-6 mt-8">
                ...
                <Link
                  to="/ressources/emissions/marie-tout-court"
                  className="group card-subtle flex gap-4 items-start"
                >
                  <Radio className="w-8 h-8 text-primary shrink-0 mt-1" />
                  <div>
                    ...
                    <h3 className="font-semibold text-foreground group-hover:text-primary transition-colors text-sm leading-snug">
                      Dialogue sur la mort, avec Marie Tout Court, créatrice de chansons pour patients en fin de vie
                    </h3>
                  </div>
                </Link>
              </div>
...
export default EmissionCatherineBossaert;
