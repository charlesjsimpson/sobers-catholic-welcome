...
const EmissionThomasHugDeLarauze = () => {
  useEffect(() => {
    document.title = "Dialogue sur la mort : Thomas Hug de Larauze, réalisateur du film Promesse | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Dialogue sur la mort sur Radio Notre Dame et RCF : Thomas Hug de Larauze, réalisateur du film Promesse, partage son regard sur la mort et la création cinématographique.");
    ...
    <div className="min-h-screen">
      ...
      <main className="pt-20">
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <div className="flex items-center gap-3 text-primary-foreground/70 text-sm mb-4">
              ...
              <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" />2 mai 2025</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Dialogue sur la mort</em> : Thomas Hug de Larauze, réalisateur du film <em>Promesse</em>
            </h1>
          </div>
        </section>
        ...
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer src={thomasImg} alt="Affiche du film Promesse de Thomas Hug de Larauze" audioUrl="https://s-c-f.org/wp-content/uploads/2025/05/conversationmort_20250502.mp3" />
            ...
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>Dans cet épisode, <strong>Thomas Hug de Larauze</strong>, réalisateur du film <em>Promesse</em>, évoque comment le cinéma peut aborder la question de la fin de vie et du deuil avec justesse et sensibilité.</p>
              <p>Il aborde notamment :</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>La genèse du film <em>Promesse</em></li>
                <li>Le cinéma comme espace de parole sur la mort</li>
                <li>La place de la promesse et de l'engagement face à la fin de vie</li>
                <li>L'émotion et la vérité dans la création artistique</li>
              </ul>
            ...
            <div className="mt-16 pt-12 border-t border-border">
              ...
              <div className="grid sm:grid-cols-2 gap-6 mt-8">
                <Link to="/ressources/emissions/marie-tout-court" className="group card-subtle flex gap-4 items-start">
                  <Radio className="w-8 h-8 text-primary shrink-0 mt-1" />
                  <div>
                    <p className="text-xs text-muted-foreground mb-1">9 mai 2025</p>
                    <h3 className="font-semibold text-foreground group-hover:text-primary transition-colors text-sm leading-snug">Dialogue sur la mort, avec Marie Tout Court, créatrice de chansons pour patients en fin de vie</h3>
                  </div>
                </Link>
...
export default EmissionThomasHugDeLarauze;
