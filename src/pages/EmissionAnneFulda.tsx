...
const EmissionAnneFulda = () => {
  useEffect(() => {
    document.title = "Dialogue sur la mort : Anne Fulda, journaliste | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Dialogue sur la mort sur Radio Notre Dame et RCF : Christian de Cacqueray reçoit Anne Fulda, journaliste, co-auteur du livre Invincible.");
        ...
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <div className="flex items-center gap-3 text-primary-foreground/70 text-sm mb-4">
              ...
              <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" />8 novembre 2024</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Dialogue sur la mort</em> : Anne Fulda, journaliste
            </h1>
          </div>
        </section>
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer src={anneFuldaImg} alt="Anne Fulda – Invincible" audioUrl="https://s-c-f.org/wp-content/uploads/2024/11/conversationmort_20241108.mp3" />
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>Dans cet épisode, <strong>Anne Fulda</strong>, journaliste, co-auteur avec Olivier Goy du livre <em>Invincible</em> (Editions Albin Michel), partage un témoignage poignant sur le combat contre la maladie et la force de l'espérance.</p>
              <p>Elle aborde notamment :</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>Le récit d'un combat contre la maladie</li>
                <li>La force de la résilience et de l'espérance</li>
                <li>Le rôle de l'écriture dans l'épreuve</li>
                <li>Le regard du journaliste sur la mort et la vie</li>
              </ul>
...
export default EmissionAnneFulda;
