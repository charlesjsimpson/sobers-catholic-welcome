...
import inesImg from "@/assets/ines-oysonville.jpeg";

const EmissionInesDOysonville = () => {
  useEffect(() => {
    document.title = "Dialogue sur la mort : Inès d'Oysonville | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Dialogue sur la mort sur Radio Notre Dame et RCF : Christian de Cacqueray reçoit Inès d'Oysonville, autrice de \"Pour de vrai, c'est quoi la mort\".");
        ...
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <div className="flex items-center gap-3 text-primary-foreground/70 text-sm mb-4">
              ...
              <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" />13 décembre 2024</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Dialogue sur la mort</em> : Inès d'Oysonville
            </h1>
          </div>
        </section>
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer src={inesImg} alt="Dialogue sur la mort – Inès d'Oysonville" audioUrl="https://s-c-f.org/wp-content/uploads/2024/12/conversationmort_20241213.mp3" />
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>Dans cet épisode, <strong>Inès d'Oysonville</strong>, autrice de "Pour de vrai, c'est quoi la mort", partage sa réflexion sur la façon de parler de la mort aux enfants.</p>
              <p>Elle aborde notamment :</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>Comment parler de la mort aux enfants</li>
                <li>Son livre "Pour de vrai, c'est quoi la mort"</li>
                <li>L'importance de ne pas cacher la réalité de la mort</li>
                <li>L'accompagnement des plus jeunes face au deuil</li>
              </ul>
...
export default EmissionInesDOysonville;
