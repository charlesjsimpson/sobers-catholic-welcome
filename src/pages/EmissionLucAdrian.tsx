...
const EmissionLucAdrian = () => {
  useEffect(() => {
    document.title = "Dialogue sur la mort : Luc Adrian, journaliste et écrivain | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Dialogue sur la mort sur Radio Notre Dame et RCF : Christian de Cacqueray reçoit Luc Adrian, journaliste et écrivain, auteur de François d'Assise : le soleil levant.");
        ...
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <div className="flex items-center gap-3 text-primary-foreground/70 text-sm mb-4">
              ...
              <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" />14 octobre 2024</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Dialogue sur la mort</em> : Luc Adrian, journaliste et écrivain
            </h1>
          </div>
        </section>
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer src={lucAdrianImg} alt="Luc Adrian – François d'Assise" audioUrl="https://s-c-f.org/wp-content/uploads/2024/10/conversationmort_20241011.mp3" />
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>Dans cet épisode, <strong>Luc Adrian</strong>, journaliste et écrivain, auteur de <em>François d'Assise : le soleil levant</em>, évoque la figure de saint François et son rapport à la mort.</p>
              <p>Il aborde notamment :</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>François d'Assise et le Cantique de Frère Soleil</li>
                <li>La mort comme « sœur » dans la spiritualité franciscaine</li>
                <li>L'écriture sur les figures de sainteté</li>
                <li>L'espérance et la joie face à la finitude</li>
              </ul>
...
export default EmissionLucAdrian;
