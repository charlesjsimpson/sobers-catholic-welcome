...
const EmissionBernardCouronne = () => {
  useEffect(() => {
    document.title = "Dialogue sur la mort : P. Bernard Couronne, père de Picpus | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Dialogue sur la mort sur Radio Notre Dame et RCF : Christian de Cacqueray reçoit le P. Bernard Couronne, père de Picpus.");
        ...
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <div className="flex items-center gap-3 text-primary-foreground/70 text-sm mb-4">
              ...
              <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" />15 novembre 2024</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Dialogue sur la mort</em> : le P. Bernard Couronne
            </h1>
          </div>
        </section>
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer src={radioImg} alt="Dialogue sur la mort – Radio Notre Dame" audioUrl="https://s-c-f.org/wp-content/uploads/2024/11/conversationmort_20241115.mp3" />
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>Dans cet épisode, le <strong>P. Bernard Couronne</strong>, père de Picpus, partage sa vision de la mort et de l'espérance chrétienne à travers son ministère.</p>
              <p>Il aborde notamment :</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>La spiritualité des Pères de Picpus</li>
                <li>L'accompagnement spirituel face à la mort</li>
                <li>La prière et l'espérance dans les derniers moments</li>
                <li>Le sens chrétien de la mort et de la résurrection</li>
              </ul>
...
export default EmissionBernardCouronne;
