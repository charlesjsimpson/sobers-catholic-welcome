...
import maximeImg from "@/assets/maxime-bolou.jpeg";

const EmissionMaximeBolou = () => {
  useEffect(() => {
    document.title = "Dialogue sur la mort : Maxime Bolou, président de l'association Ambulance des Rêves | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Dialogue sur la mort sur Radio Notre Dame et RCF : Christian de Cacqueray reçoit Maxime Bolou, ambulancier, fondateur et président de l'association Ambulance des rêves.");
        ...
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <div className="flex items-center gap-3 text-primary-foreground/70 text-sm mb-4">
              ...
              <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" />20 décembre 2024</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Dialogue sur la mort</em> : Maxime Bolou, président de l'association Ambulance des Rêves
            </h1>
          </div>
        </section>
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer src={maximeImg} alt="Dialogue sur la mort – Maxime Bolou" audioUrl="https://s-c-f.org/wp-content/uploads/2024/12/conversationmort_20241220.mp3" />
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>Dans cet épisode, <strong>Maxime Bolou</strong>, ambulancier, fondateur et président de l'association Ambulance des rêves, témoigne de son engagement auprès des personnes en fin de vie.</p>
              <p>Il aborde notamment :</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>La création de l'association Ambulance des Rêves</li>
                <li>L'accompagnement des derniers souhaits des patients</li>
                <li>Le rôle de l'ambulancier face à la fin de vie</li>
                <li>L'humanité et la dignité dans les derniers moments</li>
              </ul>
            ...
            <div className="mt-16 pt-12 border-t border-border">
              ...
              <div className="grid sm:grid-cols-2 gap-6 mt-8">
                <Link to="/ressources/emissions/dialogue-sur-la-mort-avec-frere-benjamin-pretre-salesien-createur-de-contenu-et-auteur" className="group card-subtle flex gap-4 items-start">
                  <Radio className="w-8 h-8 text-primary shrink-0 mt-1" />
                  <div>
                    <p className="text-xs text-muted-foreground mb-1">28 décembre 2024</p>
                    <h3 className="font-semibold text-foreground group-hover:text-primary transition-colors text-sm leading-snug">Dialogue sur la mort, avec Frère Benjamin, prêtre salésien, créateur de contenu et auteur</h3>
                  </div>
                </Link>
...
export default EmissionMaximeBolou;
