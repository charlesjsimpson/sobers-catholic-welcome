...
import laureImg from "@/assets/laure-de-pierrefeu.jpg";

const EmissionLaureDePierrefeu = () => {
  useEffect(() => {
    document.title = "Dialogue sur la mort : Laure de Pierrefeu | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Dialogue sur la mort sur Radio Notre Dame et RCF : Christian de Cacqueray reçoit Laure de Pierrefeu, autrice de L'écharpe oubliée.");
        ...
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <div className="flex items-center gap-3 text-primary-foreground/70 text-sm mb-4">
              ...
              <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" />19 octobre 2024</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Dialogue sur la mort</em> : Laure de Pierrefeu
            </h1>
          </div>
        </section>
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer src={laureImg} alt="Laure de Pierrefeu – L'écharpe oubliée" audioUrl="https://s-c-f.org/wp-content/uploads/2024/10/conversationmort_20241018.mp3" />
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>Dans cet épisode, <strong>Laure de Pierrefeu</strong>, autrice de <em>L'écharpe oubliée</em> (Editions City), partage un récit intime sur le deuil et la mémoire.</p>
              <p>Elle aborde notamment :</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>L'écriture comme chemin de deuil</li>
                <li>La mémoire et les objets qui relient aux disparus</li>
                <li>Le processus de reconstruction après la perte</li>
                <li>La littérature comme espace de consolation</li>
              </ul>
...
export default EmissionLaureDePierrefeu;
