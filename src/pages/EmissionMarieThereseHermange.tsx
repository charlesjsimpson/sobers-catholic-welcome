...
const EmissionMarieThereseHermange = () => {
  useEffect(() => {
    document.title = "Dialogue sur la mort : Marie-Thérèse Hermange | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Dialogue sur la mort sur Radio Notre Dame et RCF : Christian de Cacqueray reçoit Marie-Thérèse Hermange, ancienne sénatrice de Paris.");
        ...
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <div className="flex items-center gap-3 text-primary-foreground/70 text-sm mb-4">
              ...
              <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" />13 septembre 2024</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Dialogue sur la mort</em> : Marie-Thérèse Hermange
            </h1>
          </div>
        </section>
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer src={mtHermangeImg} alt="Marie-Thérèse Hermange" audioUrl="https://s-c-f.org/wp-content/uploads/2024/09/conversationmort_20240913.mp3" />
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>Dans cet épisode, <strong>Marie-Thérèse Hermange</strong>, ancienne sénatrice de Paris, autrice du livre <em>Du Mediator au Coronavirus</em>, partage sa réflexion sur la mort dans la société et les questions éthiques liées à la fin de vie.</p>
              <p>Elle aborde notamment :</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>Les questions éthiques liées à la fin de vie</li>
                <li>Le rôle du politique face à la mort</li>
                <li>La dignité humaine dans les choix de santé publique</li>
                <li>Le regard chrétien sur les débats bioéthiques</li>
              </ul>
...
export default EmissionMarieThereseHermange;
