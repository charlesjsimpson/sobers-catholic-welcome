...
const EmissionAnnaNoziere = () => {
  useEffect(() => {
    document.title = "Dialogue sur la mort : Anna Nozière, fondatrice d'une troupe de théâtre et scénariste | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Dialogue sur la mort sur Radio Notre Dame et RCF : Christian de Cacqueray reçoit Anna Nozière, fondatrice de la compagnie théâtrale Polka, scénariste.");
        ...
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <div className="flex items-center gap-3 text-primary-foreground/70 text-sm mb-4">
              ...
              <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" />3 janvier 2025</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Dialogue sur la mort</em> : Anna Nozière, fondatrice d'une troupe de théâtre et scénariste
            </h1>
          </div>
        </section>
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer src={radioImg} alt="Dialogue sur la mort – Radio Notre Dame" audioUrl="https://s-c-f.org/wp-content/uploads/2025/01/conversationmort_20250103.mp3" />
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>Dans cet épisode, <strong>Anna Nozière</strong>, fondatrice de la compagnie théâtrale Polka et scénariste, partage comment le théâtre peut aborder les questions de la mort et du deuil.</p>
              <p>Elle aborde notamment :</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>Le théâtre comme espace de parole sur la mort</li>
                <li>La compagnie Polka et ses créations</li>
                <li>L'écriture scénaristique face aux sujets de la fin de vie</li>
                <li>L'art comme vecteur de résilience et d'espérance</li>
              </ul>
...
export default EmissionAnnaNoziere;
