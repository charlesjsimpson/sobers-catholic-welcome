...
import { Phone, MapPin, Clock, ChevronLeft, ChevronRight, Star, Search, Handshake, ClipboardCheck, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        ...
        <section className="bg-background" style={{ paddingTop: 32, paddingBottom: 32 }}>
          <div className="container mx-auto px-6 max-w-4xl">
            <h2 className="font-display text-primary" style={{ fontSize: 19, fontWeight: 600, lineHeight: 1.3, marginBottom: 16, borderLeft: '3px solid hsl(var(--primary))', paddingLeft: 12 }}>
