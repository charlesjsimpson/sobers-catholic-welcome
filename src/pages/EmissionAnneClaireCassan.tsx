...
const EmissionAnneClaireCassan = () => {
  useEffect(() => {
    document.title = "Dialogue sur la mort : Anne-Claire Cassan | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Dialogue sur la mort sur Radio Notre Dame et RCF : Christian de Cacqueray reçoit Anne-Claire Cassan, autrice de Je me déploierai dans ta faiblesse.");
        ...
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <div className="flex items-center gap-3 text-primary-foreground/70 text-sm mb-4">
              ...
              <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" />20 septembre 2024</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Dialogue sur la mort</em> : Anne-Claire Cassan
            </h1>
          </div>
        </section>
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer src={anneClaireCassanImg} alt="Anne-Claire Cassan – Je me déploierai dans ta faiblesse" audioUrl="https://s-c-f.org/wp-content/uploads/2024/09/conversationmort_20240920.mp3" />
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>Dans cet épisode, <strong>Anne-Claire Cassan</strong>, autrice de <em>Je me déploierai dans ta faiblesse</em> (Artège), partage un témoignage sur la foi et la fragilité humaine face à la maladie.</p>
              <p>Elle aborde notamment :</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>Le témoignage de foi face à la maladie</li>
                <li>La force dans la faiblesse et la grâce divine</li>
                <li>L'écriture comme chemin de guérison intérieure</li>
                <li>L'espérance chrétienne dans l'épreuve</li>
              </ul>
            ...
            <div className="mt-16 pt-12 border-t border-border">
              ...
              <div className="grid sm:grid-cols-2 gap-6 mt-8">
                ...
                <Link to="/ressources/emissions/conversation-sur-la-mort-avec-marie-therese-hermange" className="group card-subtle flex gap-4 items-start">
                  <Radio className="w-8 h-8 text-primary shrink-0 mt-1" />
                  <div>
                    <p className="text-xs text-muted-foreground mb-1">13 septembre 2024</p>
                    <h3 className="font-semibold text-foreground group-hover:text-primary transition-colors text-sm leading-snug">Dialogue sur la mort, avec Marie-Thérèse Hermange</h3>
                  </div>
                </Link>
              </div>
            </div>
...
export default EmissionAnneClaireCassan;
