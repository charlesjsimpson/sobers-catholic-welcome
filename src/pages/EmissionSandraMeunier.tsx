...
const EmissionSandraMeunier = () => {
  useEffect(() => {
    document.title = "Dialogue sur la mort : Sandra Meunier, art-thérapeute | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Dialogue sur la mort sur Radio Notre Dame et RCF : Christian de Cacqueray reçoit Sandra Meunier, art-thérapeute et \"neztoile\".");
    ...
    <div className="min-h-screen">
      ...
      <main className="pt-20">
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <div className="flex items-center gap-3 text-primary-foreground/70 text-sm mb-4">
              ...
              <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" />14 mars 2025</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Dialogue sur la mort</em> : Sandra Meunier, art-thérapeute
            </h1>
          </div>
        </section>
        ...
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer src={radioImg} alt="Dialogue sur la mort – Radio Notre Dame" audioUrl="https://s-c-f.org/wp-content/uploads/2025/03/conversationmort_20250314.mp3" />
            ...
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>Dans cet épisode, <strong>Sandra Meunier</strong>, art-thérapeute et "neztoile", partage son approche de l'accompagnement par l'art.</p>
              <p>Elle aborde notamment :</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>L'art-thérapie comme outil d'accompagnement en fin de vie</li>
                <li>Son rôle de "neztoile" et la dimension créative du soin</li>
                <li>La place de l'art face à la souffrance et au deuil</li>
                <li>Des témoignages de patients accompagnés</li>
              </ul>
...
export default EmissionSandraMeunier;
