...
const EmissionFrederiqueLemarchand = () => {
  useEffect(() => {
    document.title = "Conversation sur la mort : Frédérique Lemarchand | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Conversation sur la mort sur Radio Notre Dame et RCF : Christian de Cacqueray reçoit Frédérique Lemarchand, artiste peintre et sculptrice.");
        ...
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <div className="flex items-center gap-3 text-primary-foreground/70 text-sm mb-4">
              ...
              <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" />6 septembre 2024</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Conversation sur la mort</em> : Frédérique Lemarchand
            </h1>
          </div>
        </section>
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer src={frederiqueLemarchandImg} alt="Frédérique Lemarchand" audioUrl="https://s-c-f.org/wp-content/uploads/2024/09/conversationmort_20240906.mp3" />
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>Dans cet épisode, <strong>Frédérique Lemarchand</strong>, artiste peintre et sculptrice, partage sa vision de la mort à travers l'art et la création.</p>
              <p>Elle aborde notamment :</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>L'art comme expression face à la finitude</li>
                <li>La sculpture et la peinture comme méditations sur la mort</li>
                <li>La beauté et la fragilité de la vie</li>
                <li>La création artistique comme chemin de transcendance</li>
              </ul>
...
export default EmissionFrederiqueLemarchand;
