...
const PrayingHands = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 64 64" fill="currentColor" {...props}>
    <path d="M28.5 6.2c-1.6.4-2.9 1.7-3.4 3.3-.2.7-.3 4.6-.3 13v12l-2.4-2.3c-2.7-2.6-3.9-3-5.9-2-2.4 1.2-2.9 3.4-1.4 6.4.5 1 3.2 4.4 6 7.6 5.6 6.3 7.6 9.6 8.6 14 .8 3.5 2.4 4.6 6.6 4.6 4 0 6-1 6.7-3.5.8-2.6.6-15.6-.3-19.6-.4-1.9-2.1-6.7-3.7-10.7C36.6 19 35.6 15.7 35.5 12c-.1-3.4-.3-4-1.5-5-1.5-1.2-3.7-1.6-5.5-.8z" />
    <path d="M30 8.6c-.7.7-1 3-1 7.4v6.5l-1.7-1.6c-2.2-2-4.7-2-6.7-.1-1.9 1.8-1.9 4.5 0 7.4 1.4 2.2 1.4 2.4-.5 5-1.7 2.4-1.8 3-.7 5.3 1.2 2.3 1.2 2.8-.4 5.1-1.2 1.7-1.6 3.2-1.2 4.6.4 1.1 2.7 4.1 5.2 6.7 4.4 4.6 4.5 4.7 7.7 4.4 4.5-.5 5.3-1.6 5.3-7.5 0-4.4-.4-5.5-3.5-9.9-2.5-3.6-3.5-6-3.5-8.5 0-2 .4-3.9.9-4.2.4-.3.4 1.6-.2 4.4-.5 2.7-.7 5.1-.5 5.4.3.2 1 .1 1.6-.3 1.4-.9 1.4-7.5 0-12.7-1-3.5-1.1-3.5-.8 1 .5 5.7-.4 6.7-1.7 1.7-.5-2-1.4-4.4-2-5.2-1.9-2.4 0-7-.4-12.4-.4-5.4-1.6-7.6-4-7.6-1.7 0-3.4 1-4 2.4z" transform="scale(-1,1) translate(-64,0)" />
  </svg>
);
