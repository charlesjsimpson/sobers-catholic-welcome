...
const EmissionPhilippeBaudasse = () => {
  useEffect(() => {
    document.title = "Dialogue sur la mort : Philippe Baudassé, coach et formateur | SCF";
    const meta = document.querySelector('meta[name="description"]') || document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', "Dialogue sur la mort sur Radio Notre Dame et RCF : Philippe Baudassé, coach et formateur, auteur de Deuil en nature, partage son regard sur le deuil et la reconnexion à la nature.");
      ...
      <main className="pt-20">
        <section className="bg-primary text-primary-foreground py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display leading-tight">
              <em>Dialogue sur la mort</em> : Philippe Baudassé, coach et formateur
            </h1>
          </div>
        </section>
        ...
        <article className="py-16">
          <div className="container mx-auto px-6 max-w-3xl">
            <PodcastImagePlayer
              src={philippeImg}
              alt="Quand la nature éclaire nos deuils – Philippe Baudassé"
              audioUrl="https://s-c-f.org/wp-content/uploads/2025/09/20250905-DIAMORT-Philippe-Baudasse_.mp3"
            />
            ...
            <div className="prose prose-lg max-w-none text-foreground [&>p]:mb-4 [&>p]:mt-0 [&>ul]:mb-4">
              ...
              <p>
                Dans cet épisode, <strong>Philippe Baudassé</strong>, coach et formateur, auteur de <em>Deuil en nature</em>, évoque comment la nature peut accompagner le processus de deuil et aider à traverser l'épreuve de la perte.
              </p>

              <p>Il aborde notamment :</p>

              <ul className="list-disc pl-6 space-y-2">
                <li>Le lien entre nature et processus de deuil</li>
                <li>L'accompagnement par le coaching en période de deuil</li>
                <li>La reconnexion à soi à travers l'expérience en pleine nature</li>
                <li>Son parcours et son engagement auprès des personnes endeuillées</li>
              </ul>
...
export default EmissionPhilippeBaudasse;
