          ...
          <nav className="hidden lg:flex items-center gap-0.5 flex-1 justify-center">
            {navItems.map((item, index) => (
              ...
              >
                <button
                  className={cn(
                    "flex items-center gap-1 px-4 py-2.5 text-primary-foreground text-base font-bold tracking-wide transition-colors rounded-md hover:bg-primary-foreground/10",
